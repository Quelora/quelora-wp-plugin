						...
						<form onSubmit={ handleWizardSubmit }>
							{ ! useManualUpload ? (
								<TextControl
									...
									required
									help={ __( 'Format: URL:CID:Secret (e.g., https://api-dashboard.quelora.dev:QU-XXXXX:MySecret)', 'quelora' ) }
								/>
							) : (
								<>
									<TextControl
							...
							<>
								...
								<PanelBody title={ __( 'Mount Points & APIs', 'quelora' ) }>
									...
									<TextControl
										...
										help={ __( 'Base URL for the primary Quelora API (e.g., https://api.quelora.dev).', 'quelora' ) }
									/>
									<TextControl
										label={ __( 'Dashboard API URL', 'quelora' ) }
										value={ state.dashboardApiUrl }
										onChange={ ( val ) => updateState( 'dashboardApiUrl', val ) }
										help={ __( 'Base URL for Dashboard synchronization (e.g., https://api-dashboard.quelora.dev).', 'quelora' ) }
									/>
									<TextControl
